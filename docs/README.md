...
This documentation corpus describes **what DAAD Harvester can measure**, the evidence needed for each claim, and the boundaries it deliberately preserves instead of guessing. It is organized for future preservation, archaeology, and interpreter work, including a potential ScummVM-oriented implementation.
...
The implementation source of truth remains the test suite and the typed evidence persisted in SQLite. Documentation explains intent and provenance; it does not replace structural validation.
