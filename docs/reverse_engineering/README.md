...
| [Architecture workflows](ARCHITECTURE_WORKFLOWS.md) | Planned reproducible analysis workflow per processor family. | Planned |
| [Interpreter inventory](INTERPRETER_INVENTORY.md) | Per-binary/source/derivative provenance and analysis state. | Planned |
| [Cross-tool verification](CROSS_TOOL_VERIFICATION.md) | Agreement/disagreement protocol for disassembly and decompiler outputs. | Planned |
