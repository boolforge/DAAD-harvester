...
| `library` | Manifest or unavailable sentinel with summary/artifacts. | Removes each library artifact’s operational `source_path` and links only to relative deployment assets. |
