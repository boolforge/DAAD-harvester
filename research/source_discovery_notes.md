...
## From Out of the Snow source boundary

Spectrum Computing entry 34903 provides public 2019 media for **From Out Of The Snow**, but identifies the original publisher as **Zenobi Software** and its engine as **Professional Adventure Writer**. This conflicts with the catalog candidate’s publisher **Pension Productions** and does not evidence a DAAD edition. The TAP/DSK/MGT files are therefore not registered for the DAAD candidate; it remains in `discovery_required` pending a source that closes both boundaries.
...
## Spectrum Computing DAAD relationship catalog

On 2026-08-22, the public DAAD record at <https://spectrumcomputing.co.uk/entry/30013/ZX-Spectrum/DAAD> was inspected. Its **Programs authored (or executed) with this title** section is catalog-discovery evidence only; it does not establish a direct binary download, a byte-measured engine profile, release identity outside the displayed fields, or a source-specific publication right. The page supplies a linked ZXDB entry, displayed publisher label, and displayed year when present; it does not supply a language for every row, and absent years remain unknown.

Beyond the CASA-derived candidate manifest, it visibly lists leads including *13 Rue del Percebe: El Nacimiento de la Leyenda* (2023), *Las Aventuras de Rudolphine Rur* (2020), *Beltalowda* (2025), *A Case of Murder 128K* (2023), *The Dragnet Case Re-Release* (2023), *Los Elfos de Maroland 2023* (2023), *Erinia (Enhanced version)* (2024), *La Estrella de la Mañana 2023* (2023), *Excalibur: Sword of Kings Remake* (2019), *Imprisoned* (2023), *Karhum* (2019), *Last Night in the Office* (2020), *The Legacy of Markham Island* (2022), *Licence to Mow* (2023), *Mad Gods* (2023), *The Mystery of Markham Manor* (2022), *One Last Thing* (2020), *Pandemia XXI* (2019), *Proyecto Vampiro* (2019), *The Revenge of Moriarty* (2019), *Terror by Night* (2023), *Top Gun 2: Maverick Dangerous!* (2022), *Torreoscura* (2020), and *ZHL* (2016). It also lists *La Celda* and *El Dia Que Lo Entiendas Se Acaba El Mundo* without displayed years.

The page preserves material edition discrepancies: it names **Lost** for *Colour Beyond Time* (2022), gives **2020** for both listed *The Curse of Rabenstein* relationships, lists *Eight Feet Under* as a **2018** Pond Software relationship, and gives **2015** for *El Cetro del Sol*. These observations do not reconcile or replace the distinct CASA candidates. A versioned Python capture and a source-specific catalog-only manifest are required before any new candidate is added; each future acquisition still requires a direct-media source, a checksum, and an edition-identity validation.

## Spectrum Computing linked-entry discovery batch

On 2026-08-22, the retained Spectrum Computing relationship snapshot was replayed through the versioned `discover_spectrum_computing_sources.py` adapter with a fixed capture epoch. The bounded 40-entry ZX batch is retained in `research/candidate_spectrum_source_discovery.json`. It identified **19** release-boundary source candidates by the displayed title, publisher, year, and observed message language where the catalog candidate left language unknown. Direct source candidates include *13 Rue del Percebe: El Nacimiento de la Leyenda* (Spanish, 2023), *A Case of Murder 128K* (English, 2023), *Beltalowda* (English/Spanish listing, 2025), *El Cetro del Sol* (Spanish, 2015), *ELF, La Aventura - Parte 1* (Spanish, 2016), and *Excalibur: Sword of Kings Remake* (English, 2019).

This batch is **discovery evidence only**. The public media URLs have not been registered, fetched, checksummed, or promoted to the acquisition queue. The source-reported language is retained as observed source evidence rather than replacing the catalog candidate’s `Unknown` language field. The one `ZX-Spectrum_Next` relationship is explicitly reported as outside this ZX Spectrum adapter profile; unmatched and platform-outside records remain in `discovery_required` with their exact result state.
