...
| 68000 / i8086 | [Capstone](https://github.com/capstone-engine/capstone) at `3a8d30a66726fd31990fa584f62fd30dcd9f9b50` | Repository metadata lists M68K, MOS65XX, and X86 among its supported disassembly families. | The inspected metadata did not provide a detected license identifier; a stable local CLI/API harness, exact mode mapping, and raw-input test fixture must be defined before admission. |
