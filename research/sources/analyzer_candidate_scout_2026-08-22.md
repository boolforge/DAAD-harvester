...
| --- | --- | --- | --- |
| [py8dis](https://github.com/ZornsLemma/py8dis) | Python-based programmable static tracing disassembler; repository metadata reports an MIT license. | Candidate for MOS 6502-family research only. | Do not configure against retained C64 or Plus/4 bytes until its command, origin, and 6502-versus-8501 semantics are pinned and compared with the current `da65`, Ghidra, and radare2 records. |
