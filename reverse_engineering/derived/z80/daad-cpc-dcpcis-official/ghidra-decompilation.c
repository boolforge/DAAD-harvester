...
void RST0(undefined1 *param_1,char param_2)

{
  undefined2 in_AF;
  
  *(char *)CONCAT11(param_2,*param_1) = (char)((ushort)in_AF >> 8);
  if (!SBORROW1(param_2 + -1,'\x01')) {
    return;
  }
...
void RST1(undefined1 *param_1,char param_2)
...
void RST2(undefined1 *param_1,char param_2)
...
undefined1 RST3(undefined1 param_1,char param_2)
...
void RST4(char param_1)

{
  if (!SBORROW1(param_1,'\x01')) {
    return;
  }
                    /* WARNING: Bad instruction - Truncating control flow here */
  halt_baddata();
