...

{
  ...
  DAT_ram_d069 = (undefined1)((ushort)param_2 >> 8);
  sRamd0a6 = param_1 + -4;
  sVar3 = -0x2e99;
  DAT_ram_d166 = DAT_ram_d166 & 0xbf;
  cVar1 = DAT_ram_d06d;
  if (DAT_ram_d06d == '\0') {
    func_0xc8d8(8);
    cVar1 = func_0xcd40();
  ...
  *(byte *)(sVar3 + -1) = *(byte *)(sVar3 + -1) & 0xfb;
  func_0xcb26();
  LAB_ram_cfcf = 0xd;
  _DAT_ram_d048 = &LAB_ram_cfcf;
  *(undefined1 *)(sVar3 + -7) = 0x78;
  bVar2 = (byte)(_DAT_ram_d06c >> 8);
  if (bVar2 != 0) {
                    /* WARNING: Could not recover jumptable at 0x0077. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)((ushort)bVar2 << 8 | _DAT_ram_d06c & 0xff))(bVar2);
    return;
  }
                    /* WARNING: Bad instruction - Truncating control flow here */
  halt_baddata();
...

{
  ...
  *(undefined1 *)(sVar4 + -7) = 0x78;
  bVar3 = (byte)(_DAT_ram_d06c >> 8);
  if (bVar3 != 0) {
                    /* WARNING: Could not recover jumptable at 0x0077. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)((ushort)bVar3 << 8 | _DAT_ram_d06c & 0xff))(bVar3);
    return;
  }
                    /* WARNING: Bad instruction - Truncating control flow here */
  halt_baddata();
...

{
  ...
  *param_1 = 0xd;
  _DAT_ram_d048 = param_1;
  *(undefined1 *)(param_2 + -7) = 0x78;
  bVar1 = (byte)(_DAT_ram_d06c >> 8);
  if (bVar1 != 0) {
                    /* WARNING: Could not recover jumptable at 0x0077. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (*(code *)((ushort)bVar1 << 8 | _DAT_ram_d06c & 0xff))(bVar1);
    return;
  }
                    /* WARNING: Bad instruction - Truncating control flow here */
  halt_baddata();
