...
@pytest.mark.parametrize("mutation,msg",[(lambda c:c.__setitem__("execution_eligible",True),"must not enable execution"),(lambda c:c["profiles"][0].__setitem__("basic_sys_entry",0),"SYS 2063"),(lambda c:c["profiles"][0].__setitem__("entry_state_observation",{}),"exactly the hash-bound required fields")])
