...
function resourceBoundary(artifact: Artifact) {
  ...
  if (artifact.media_parser === "daad-legacy-chr") return "CHR container and any recognized header profile are measured; glyph preview publication requires a separately verified derivative.";
